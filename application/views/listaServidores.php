            ...
            <div id="navbar-inner" class="navbar-inner">
                <div id="container-fluid" class="container-fluid fundo-verde">
                    ...
                    <div id="nav" class="nav-collapse collapse <?php echo @$hide;?>">
                        <ul class="nav">
                            <li><a href="<?php echo base_url('servidores/listaServidores'); ?>">Inicio</a></li> 
                            <li><a href="<?php echo base_url('servidores/incluir'); ?>">Cadastrar servidor</a></li>
                            <li><a href="<?php echo base_url("servidores/alterar/{$servidor->id_servidor}\\"); ?>">Alterar servidor</a></li>
...
<!--footer---------------------->
        <div class="navbar-fixed-bottom">    			 			
            <footer>
                <p class="pull-right">GEATI_by->Altair</p>
            </footer>
        </div>
